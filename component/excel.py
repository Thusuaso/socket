    ...
    def maliyet_rapor_ciktisi(self,data_list):
            try:
                ...
                for item in data_list:
                    ...
                    sayfa.cell(satir,column=13,value=item['dis_alim'])
                    sayfa.cell(satir,column=14,value=item['nakliye'])
                    sayfa.cell(satir,column=15,value=item['gumruk'])
                    sayfa.cell(satir,column=16,value=item['ilaclama'])
                    sayfa.cell(satir,column=17,value=item['liman'])
                    sayfa.cell(satir,column=18,value=item['sigorta'])
                    sayfa.cell(satir,column=19,value=item['navlun'])
                    sayfa.cell(satir,column=20,value=item['detay_1'])
                    sayfa.cell(satir,column=21,value=item['detay_2'])
                    sayfa.cell(satir,column=22,value=item['detay_3'])
                   
                   
                    sayfa.cell(satir,column=23,value=item['ozel_iscilik'])
                    sayfa.cell(satir,column=24,value=item['banka_masrafi'])
                    sayfa.cell(satir,column=25,value=item['kurye_masrafi'])
                    ...
                    sayfa.cell(satir,column=29,value=item['dosya_kapanma_date'])
